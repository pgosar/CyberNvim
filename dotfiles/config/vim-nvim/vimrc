...
set tabstop=2 softtabstop=0                     " tab settings
...
call plug#begin('~/.config/nvim/plugged')
  ...
  " Lang Plugins {
    ...
    Plug 'ap/vim-css-color'                     " Color syntax for css
  " }
  " Git {
...
" Limelight {
  nnoremap <silent> <space>lm :Limelight<CR>
  nnoremap <silent> !lm :Limelight!<CR>
" }
" CHADTree {
...
" }
" telescope {
  nnoremap ff :Telescope git_files hidden=true<cr>
  nnoremap fg :Telescope live_grep<cr>
  nnoremap fb :Telescope buffers<cr>
  nnoremap fh :Telescope help_tags<cr>
" }
" gitgutter {
  nnoremap <Leader>df :GitGutterDiffOrig<cr>
...
" cycle between hunks
function! GitGutterNextHunkCycle() abort
  let line = line('.')
...
function! GitGutterPrevHunkCycle() abort
  let line = line('.')
...
function! NextHunkAllBuffers() abort
  let line = line('.')
  GitGutterNextHunk
  if line('.') != line
    return
...
function! PrevHunkAllBuffers() abort
  let line = line('.')
  GitGutterPrevHunk
  if line('.') != line
    return
